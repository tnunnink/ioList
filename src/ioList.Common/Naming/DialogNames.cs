namespace ioList.Common.Naming
{
    public class DialogNames
    {
        ...
        public static readonly string ConfirmationDialog = nameof(ConfirmationDialog);
        ...
        public static readonly string DeleteListDialog = nameof(DeleteListDialog);
        public static readonly string RemoveListDialog = nameof(RemoveListDialog);
        public static readonly string ImportDialog = nameof(ImportDialog);
    }
}